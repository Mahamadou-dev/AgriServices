      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Agriculteurs</h1>
              <p className="text-gray-500">{farmers.length} agriculteur(s) enregistré(s)</p>
            </div>
          </div>
          <Button 
        ...
        {/* Error Alert */}
        {error && (
          <div className="flex items-center gap-3 bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-xl mb-6 animate-shake">
        ...
        {farmers.length === 0 ? (
          <Card className="text-center py-12">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Aucun agriculteur</h3>
